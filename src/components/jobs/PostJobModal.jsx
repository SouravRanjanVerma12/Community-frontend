    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-w-[560px] max-h-[92vh] sm:max-h-[88vh] overflow-y-auto scrollbar-none bg-card rounded-t-[28px] sm:rounded-[24px] shadow-[0_-12px_40px_rgba(0,0,0,0.4)] sm:shadow-[inset_0_1px_0_rgba(255,255,255,0.05),0_24px_48px_-12px_rgba(0,0,0,0.3)] border-t sm:border border-border/50"
        >
